...
### TOQUE 1 · D+30 — Reconexão
**Objetivo:** reconectar de forma leve, lembrar que desparasitação natural é rotina (2–4x/ano na lua nova) e convidar a preparar o próximo ciclo.

**WhatsApp** (categoria HSM: utility)
...
- Corpo:
  ...
  Um abraço,
  Equipe VermeFree
- CTA (texto do botão): Preparar meu próximo ciclo
- Cupom: BEMVINDO10 — 10% OFF, sem prazo definido neste toque (uso livre)
- Rodapé: Oferta pontual, por tempo limitado. Frete grátis acima de R$399.

---

### TOQUE 2 · D+45 — Reforço com prova social
**Objetivo:** trazer prova social nativa (relatos reais de leveza/rotina) e deixar o CTA mais direto que no Toque 1.

**WhatsApp** (categoria HSM: marketing)
...
- Corpo:
  ...
  Um abraço,
  Equipe VermeFree
- CTA (texto do botão): Quero voltar ao meu ritmo
- Cupom: BEMVINDO10 — 10% OFF, sem prazo definido neste toque (uso livre)
- Rodapé: Oferta pontual, por tempo limitado. Frete grátis acima de R$399.

---

### TOQUE 3 · D+90 — Última chamada (sem culpa)
**Objetivo:** oferecer uma janela final com desconto maior e prazo curto, em tom respeitoso — sem cobrança, deixando a porta aberta pro winback trimestral depois.
...
- Corpo:
  ...
  Um abraço,
  Equipe VermeFree
- CTA (texto do botão): Retomar meu protocolo
...
- [x] Linguagem seg­ura usada em todas as peças ("auxilia na desparasitação", "rotina de limpeza natural", "bem-estar", "leveza", "constância", "no ritmo da lua nova")
