...
> Brief completo pra construir as **LPs de venda por produto** (tráfego pago), uma por SKU — escopo diferente do `linktree-vermefree/` (bio-link). Contém a ficha real (variant ID, preço, composição, dores/desejos/ganchos) de cada um dos 5 produtos listados em `PAGINAS.md`.
>
...
### 🧴 Protocolo Adulto
- **Slug/pasta:** `landing-protocolo-adulto/` · **Handle:** `protocolo-desparasitacao-adulto-vermefree` · **VARIANT_ID:** `48772143415515`
...
- **Slug/pasta:** `landing-kids-2-4/` · **Handle:** `antiparasitario-infantil-natural-vermefree-kids-2-a-4-anos` · **VARIANT_ID:** `48772145250523`
...
- **Slug/pasta:** `landing-kids-5-9/` · **Handle:** `antiparasitario-infantil-natural-vermefree-kids-5-a-9-anos` · **VARIANT_ID:** `48772147085531`
...
- **Slug/pasta:** `landing-kit-familia/` · **Handle:** `kit-familia-vermefree-2-adultos-2-criancas` · **VARIANT_ID:** `48772149739739`
